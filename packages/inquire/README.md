...
- **[Create](https://github.com/stackpress/inquire/blob/main/docs/builders/Create.md)** - Create tables and schemas
- **[Alter](https://github.com/stackpress/inquire/blob/main/docs/builders/Alter.md)** - Modify existing tables
- **[Select](https://github.com/stackpress/inquire/blob/main/docs/builders/Select.md)** - Query data with joins, conditions, and aggregations
- **[Insert](https://github.com/stackpress/inquire/blob/main/docs/builders/Insert.md)** - Insert single or multiple records
- **[Update](https://github.com/stackpress/inquire/blob/main/docs/builders/Update.md)** - Update existing records
- **[Delete](https://github.com/stackpress/inquire/blob/main/docs/builders/Delete.md)** - Delete records with conditions
...
- **[Engine](https://github.com/stackpress/inquire/blob/main/docs/Engine.md)** - Core engine class and methods
- **[Connection Classes](https://github.com/stackpress/inquire/blob/main/docs/Connections.md)** - Database-specific connection implementations
- **[Query Builders](https://github.com/stackpress/inquire/blob/main/docs/builders/README.md)** - Detailed documentation for all query builders
- **[SQL Dialects](https://github.com/stackpress/inquire/blob/main/docs/dialects/README.md)** - Detailed documentation for all SQL dialects
- **[Examples](https://github.com/stackpress/inquire/blob/main/docs/Examples.md)** - Comprehensive usage examples

## Examples

Check out the [examples directory](https://github.com/stackpress/inquire/blob/main/examples) for complete working examples with different database engines:

- [MySQL Example](https://github.com/stackpress/inquire/blob/main/examples/with-mysql2)
- [PostgreSQL Example](https://github.com/stackpress/inquire/blob/main/examples/with-pg)
- [SQLite Example](https://github.com/stackpress/inquire/blob/main/examples/with-sqlite3)
- [PGLite Example](https://github.com/stackpress/inquire/blob/main/examples/with-pglite)
